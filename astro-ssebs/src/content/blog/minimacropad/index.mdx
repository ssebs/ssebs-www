...
import pythonMmpScreenshot from './img/PythonMMPScreenshot.png';
import mmpGuiScreenshot from './img/MMPGUIScreenshot.png';

> Read the technical details on the [project page](/projects/go-mmp)

## What's a Macro Pad?
<ImgFloatRight src={mmpPrinted} width="256px" alt="physical macro pad" />
...
<ImgBlock src={mmpWiring} width="400px" alt="macro pad wiring" />
...
<ImgFloatRight src={pythonMmpScreenshot} alt="python gui screenshot" />
...
<ImgFloatRight src={mmpGuiScreenshot} width="400px" alt="Mini Macro Pad Screenshot" />
