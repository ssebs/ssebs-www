...
import s4Img from './img/s4.jpg';
import s4TurkeyImg from './img/s4_turkey.jpg';

I used to own a 2014 Audi S4 (B8.5), had a few mods done, but ultimately it was too expensive to keep 😭.

<Img src={s4Img} title="picture of my s4" />
...
- A turkey jumped in front of my car one day, causing lots of damage
  - <Img src={s4TurkeyImg} title="smashed windshield on my car" class="w-[300px]" />
