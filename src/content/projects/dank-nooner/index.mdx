...
feature: ./img/DankNoonerIcon.jpg
...
import dankNoonerV66 from './img/dank-nooner-v66.webp';
import dankNoonerV80 from './img/dank-nooner-v80.jpg';
import dankNoonerV80_2 from './img/dank-nooner-v80-2.jpg';
import dankNoonerBikeSkin from './img/dank-nooner-bike-skin.png';
...
import screenshot04 from './img/screenshot04.png';

<ImgFloatRight src={dankNoonerV66} width="400px" alt="Gameplay clip from Dank Nooner V2" loading="lazy" />
...
<ImgFull src={dankNoonerV80} alt="Dank Nooner V2 gameplay" loading="lazy" />


## How it's built

<ImgFloatRight src={dankNoonerBikeSkin} width="400px" alt="Bike customization in Dank Nooner" />
...
<ImgFull src={dankNoonerV80_2} alt="Dank Nooner V2 gameplay" loading="lazy" />
...
<GameEmbed src="/dank-nooner-v1/" width="100%" height="600px" />

## V1 Screenshots

<ImgFull src={screenshot01} alt="Screenshot of the game in the main menu" />

<ImgFull src={screenshot03} alt="Screenshot of the gameplay, holding a wheelie" />

<ImgFull src={screenshot02} alt="Screenshot of the game in the tutorial" />

<ImgFull src={screenshot04} alt="Screenshot of the game in the upgrade menu" />
