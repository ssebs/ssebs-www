...
import guiEditorDiagram from './img/GUIEditorDiagram.png';
import mmpNewWindows from './img/mmpnewwindows.png';
import fyneDraggableApi from './img/fyne-draggable-api.png';
import whoWroteThisCode from './img/whowrotethiscode.jpg';
...
<ImgBlock src={mmpPrinted} class="w-96 mx-auto my-4" alt="macro pad" />
...
<ImgBlock src={guiEditorDiagram} class="w-full" alt="GUI Editor Diagram" />
...
<ImgBlock src={mmpNewWindows} class="w-full" alt="" />
...
<ImgBlock src={fyneDraggableApi} class="w-full" alt="" />
...
<ImgBlock src={whoWroteThisCode} class="w-96 mx-auto my-4" alt="Obi Wan meme" />
