...
import vibeCoding1 from './img/vibe-coding-1.png';
import todoSidebarMd from './img/todo-sidebar-md.png';
import dankNoonerSettingsMenu from './img/dank-nooner-settings-menu.png';
import dankNoonerBikeSkin from './img/dank-nooner-bike-skin.png';
import dankNoonerSkeletonGen from './img/dank-nooner-skeleton-gen.png';
...
<ImgFloatRight src={vibeCoding1} width="400" alt="An illustration of an AI chat prompt input field. The text 'do it all for me' is crossed out in red. Below it, 'help me think through this' has a green checkmark" />
...
<ImgFull src={todoSidebarMd} alt="screenshot of the extension" />
...
<ImgFloatRight src={dankNoonerSettingsMenu} width="600" alt="screenshot dank nooner showing settings menu" />
...
<ImgFloatRight src={dankNoonerBikeSkin} width="600" alt="screenshot from godot editor showing the generated skeleton" />
...
<ImgFull src={dankNoonerSkeletonGen} alt="screenshot from godot editor showing the generated skeleton" />
