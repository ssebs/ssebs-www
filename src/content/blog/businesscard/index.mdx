...
import bambuCarbonFxPlate from './img/bambu-carbon-fx-plate.jpg';
import bizcardcad from './img/bizcardcad.png';
import bizcardsteps from './img/bizcardsteps.jpg';
import bizcardfront from './img/bizcardfront.jpg';
import bizcardback from './img/bizcardback.jpg';
...
<ImgFloatRight src={bambuCarbonFxPlate} width="256px" alt="Carbon Fiber effects plate" />
...
<ImgFull src={bizcardcad} alt="cad screenshot of business card" />
...
<ImgFull src={bizcardsteps} alt="workflow of business card creation" />
...
<ImgBlock src={bizcardfront} width="400px" alt="front of business card" />
</div>
<div>

The back features the carbon fiber texture:
<ImgBlock src={bizcardback} width="400px" alt="back of business card" />
