...
import goDeaf from './img/go_deaf.png';
import washHands from './img/wash_hands.png';
import zombieHallway from './img/zombie_hallway.png';
import takingOrder from './img/taking_order.png';
...
## Status Update
<ImgFloatRight src={outside} width="512px" alt="Game screenshot" />
...
### Going deaf
<ImgFloatRight src={goDeaf} width="512px" alt="Screenshot of going deaf button in pause menu" />
...
### Washing your hands
<ImgFloatRight src={washHands} width="512px" alt="Screenshot of player washing hands" />
...
<ImgFloatRight src={zombieHallway} width="512px" alt="Screenshot of zombies" />
...
### 100% perfect orders
<ImgFloatRight src={takingOrder} width="512px" alt="Screenshot of taking orders" />
...
<ImgBlock src={meme} class="m-3" width="500px" alt="Meme" />
