...
feature: ./img/moto-player-controller-wheelie-anim.png
...
import motoLeaningAnim from './img/moto-player-controller-leaning-anim.png';
import motoWheelieAnim from './img/moto-player-controller-wheelie-anim.png';
import ikVideo from './img/godot-inverse-kinematics.mp4';
...
<ImgFloatRight src={screenshot03} width="400" alt="dank nooner screenshot" />
...
<ImgFloatRight src={motoLeaningAnim} alt="Player controller leaning over animation" width="500" />
...
<ImgFloatRight src={motoWheelieAnim} width="500" alt="moto-player-controller-wheelie-animation" />
