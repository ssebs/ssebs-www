...
const projects = [
    {
      ...
      "content": "This is a react frontend web application to control / modify users in a database.\\n\\n Check out http://ppldb-py-react.ssebs.com/ and http://ppldb-py-react.ssebs.com.\n"
    },
    {
      "id": 2,
      "title": "React ToDo Cookies",
      "summary": "This is a basic todo app that saves your todos in localStorage (\"cookie\"), so you can \"save\" it.",
      "techs": [
        "js",
        "react"
      ],
      ...
      "content": "This is a basic todo app that saves your todos in localStorage (\"cookie\"), so you can \"save\" it. \n"
    },
    {
      "id": 3,
      "title": "jwt-example",
    ...
    },
    {
      ...
      "summary": "GUI program to clean a mac address (F01898b4EA08 -> f0:18:98:b4:ea:08)",
      "techs": [
        "python"
      ],
      "githublink": "https://github.com/ssebs/clean-mac-address",
      "demolink": null,
      "content": "\"GUI program to clean a mac address (F01898b4EA08 -> f0:18:98:b4:ea:08)\\n\\nProgram to \"clean\" MAC address for registrar input.\"\n"
    },
    {
      "id": 9,
      "title": "PeopleDB",
